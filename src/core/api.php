...
class api
{
    ...
    public $a_status_code = array(
        ...
        "400" => array(
            "base" => array(
                ...
                "Status"      => 400,
                "Message"     => "Bad Request",
                "Description" => "#2. HTTP response for the request by the client 
                    was not processed, as the server 
                    could not understand what the client is asking for",
                "Required"    => array(),
            ),
            "header" => array(),
        ),
        "404" => array(
            "base" => array(
                ...
                "Status"      => 404,
                "Message"     => "Not Found",
                "Description" => "HTTP response for the requested resource is not 
                    available to access",
                "control"     => "",
            ),
            "header" => array(),
    ...
    public function products( $a_parameters = null )
    {
        ...
        $a_request_result = \APP\resource\products::request(
            array(
            "request_method" => $s_request_method,
    ...
    public function product_photos( $a_parameters = null )
    {
        ...
        $a_request_result = \APP\resource\product_photos::request(
            array(
            "request_method" => $s_request_method,
            "request_id"     => $s_param_request_id,
