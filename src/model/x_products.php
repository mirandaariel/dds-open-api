...
class x_products extends _x_productsBase {
    public $oYApp = null;
    public $aLabels = [];
    public $a_relation = [];
    ...
    public function __construct () {
        ...
        $this->aLabels = array(
            "title"         => "x_products",
            "title-default" => "Entidad x_products",
            "plural"        => "x_products",
            "singular"      => "x_products",
        );
        $this->oYApp = $oYApp;
        ...
        $this->a_property['product_name']       ['s_label'] = "Nombre";
        $this->a_property['product_description']['s_label'] = "Descripción";
    ...
    public function delete( $a_parameters = null ) {
        ...
        $s_record_update_user_id = $this->oYApp->a_data['usuario'][0]['id'];
        $s_record_update_user_id_url = $this->oYApp->a_data['usuario'][0]['id_url'];
    ...
    static public function get_list_config( $a_parameters = null ) {
        ...
        $a_crud_actions = x_products::get_crud_actions( $a_parameters );
        ...
        $a_list_config = array(
            ...
            "body_actions" => array(
                ...
                "Descuento" => array(
                    "label" => "Clientes",
                    "href"  => $a_parameters['module_http'] . "main/x_products_cliente?place=",
                ),
                */
            ),
            "data" => array(
    ...
    public static function get_dropdown_config_data( $a_parameters = null ) {
        ...
        $b_param_selected = isset( $a_parameters['selected'] );
        $a_param_selected = $b_param_selected ? $a_parameters['selected'] : array();
        ...
        foreach ( $a_data_param as $i_instancia => $a_instancia ) {
            ...
            //echo "<pre> a_instancia: "; var_dump( $a_instancia ); echo "</pre>";
            //echo "<pre> a_param_selected: "; var_dump( $a_param_selected ); echo "</pre>";
            //exit();
            ...
            if ( in_array( $a_instancia['id'], $a_param_selected ))
                $a_item['s_selected'] = "selected";

            $a_form_clientes[] = $a_item;
        }
    ...
    public static function get_instance_label( $a_parameters = null ) {
        ...
        $s_label = $a_parameters['product_name'];
    ...
    public static function report_data ( $a_parameters = null ) {
        ...
        $s_query = "SELECT
            * 
            FROM x_products
            WHERE x_products.record_delete_flag = 0
            ORDER BY x_products.id ASC";
