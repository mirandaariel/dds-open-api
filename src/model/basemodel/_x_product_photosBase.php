...
class _x_product_photosBase extends clas {
  ...
  public function __construct () {
    ...
    $this->a_property = array(
      ...
      "x_product_id" => array(
        ...
        "s_name"   => "x_product_id",
        "s_type"   => "int",
        "s_label"  => "x_product_id",
        "a_grid"   => array(
            "s_field"        => "x_product_id",
            "s_column_label" => "",
            "s_align"        => "left",
            "i_width"        => 100,
            "i_height"       => 30,
      ...
      "x_product_id_url" => array(
        "b_key"    => false,
        "b_unique" => false,
        "s_name"   => "x_product_id_url",
        "s_type"   => "varchar",
        "s_label"  => "x_product_id_url",
        "a_grid"   => array(
            "s_field"        => "x_product_id_url",
            "s_column_label" => "",
            "s_align"        => "left",
            "i_width"        => 100,
            "i_height"       => 30,
    ...
    $this->aGrid = array( 
      ...
      array( "photo_name", "photo_name", 60, 30, true, "center", false, false ), 
      array( "photo_url", "photo_url", 60, 30, true, "center", false, false ), 
      array( "photo_order", "photo_order", 60, 30, true, "center", false, false ), 
      array( "x_product_id", "x_product_id", 60, 30, true, "center", false, false ), 
      array( "x_product_id_url", "x_product_id_url", 60, 30, true, "center", false, false ), 
    ...
    $this->aBase['aEnti'][] = "x_product_photos";                                                               // nombre de la tabla en la base de datos.
